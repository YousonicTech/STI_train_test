...
def parse_args():
    ...
    parser.add_argument('--model_path', type=str, default='save_model/0923_STI_FPN_lre5_alpha1_beta05/')
    parser.add_argument('--epoch_for_save', type=int, default=9)  # 记得改epoch数
    ...
    parser.add_argument('--outputresult_dir', type=str, default="./0923_test/epoch9") # 记得改输出路径，不用带/应该
...
if __name__ == "__main__":
    ...
    if DEBUG == False:
        ...
        val_dict_root = "/data/xbj/0922_STI_FPN/val"
        failed_file = "/data/xbj/0922_STI_FPN/val/Seven_Config/Seven_Config_junzheng3dahui02_left_Seven_Config_DR4_FKDW0_SI1207_TIMIT_S_1000dB-0.pt"
        val_batch_size = 10
