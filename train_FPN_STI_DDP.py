...
if __name__ == "__main__":
    ...
    if DEBUG == False:
        ...
        train_sampler = torch.utils.data.distributed.DistributedSampler(train_transformed_dataset)
        train_loader = torch.utils.data.DataLoader(train_transformed_dataset,
        ...
        val_sampler = torch.utils.data.distributed.DistributedSampler(val_transformed_dataset)
